...
### Chance the Rapper
I also made a few Chance the Rapper-flavored pens. The first was [Grab the Chano](http://codepen.io/jakealbaugh/full/ONPYxo), a pixelated face that sings when you grab it. If you are on a desktop, you can grab it below.

<iframe height='600' scrolling='no' title='Grab the Chano' src='//codepen.io/jakealbaugh/embed/ONPYxo/?height=600&theme-id=21346&default-tab=result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/jakealbaugh/full/ONPYxo/'>Grab the Chano</a> by Jake Albaugh (<a href='http://codepen.io/jakealbaugh'>@jakealbaugh</a>) on <a href='http://codepen.io'>CodePen</a>.</iframe> <!-- iframe -->

Then I made [Chance the Sampler](http://codepen.io/jakealbaugh/full/eZJmQK) which is a a sampler/sequencer with pads that you can program using samples of Chance’s voice.
...
http://codepen.io/jakealbaugh/post/firebase-tone-js-and-device-orientation
...
### Audio VisualEyezer
http://codepen.io/jakealbaugh/full/ObOPEV
...
A [CSS Calculator](http://codepen.io/jakealbaugh/full/mVYgLo) that isn’t that useful.
...
## Fuzzy Search
http://codepen.io/jakealbaugh/full/wzzrmX

https://github.com/jakealbaugh/fuzzy-search
...
## CodePen & Community
http://codepen.io/jakealbaugh/post/codepen-community
